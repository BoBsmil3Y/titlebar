...
public class cmd_subtitlebar
implements CommandExecutor {
	public titlebar plugin;

	public cmd_subtitlebar(titlebar plugin) {
		this.plugin = plugin;
	}
						...
						if (args.length >= 3) {
							if (p.hasPermission(vars.permission_privateTb)) {
								...
								if (t != null) {
									...
									theTitle.sendTitle(t, "&r", msg, this.plugin, colors);
